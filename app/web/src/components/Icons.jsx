...
export const Icon = {
  ...
  graph: (p) => (<svg {...base} {...p}><circle cx="6" cy="7" r="2.6" /><circle cx="18" cy="6" r="2.2" /><circle cx="12" cy="17" r="2.8" /><path d="M8.2 8.6 10.4 14.6M16.2 7.7 13.6 14.9M8.5 6.4l7.2-.3" /></svg>),
